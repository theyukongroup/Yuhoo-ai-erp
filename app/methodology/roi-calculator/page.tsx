...
export const metadata=authorityMetadata('Productivity Calculator Methodology','Assumptions, inputs, interpretation, and limitations for the Yuhoo AI and ERP productivity calculator.','/methodology/roi-calculator');

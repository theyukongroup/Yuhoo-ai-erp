...
export const metadata: Metadata = pageMetadata('Business Server Equipment', 'The practical on-premises server platforms Yuhoo recommends for Odoo ERP and private AI workloads.', '/equipment');
...
const systems = [
  {
    number: '01', name: 'Yuhoo Basic', label: 'Capable local foundation',
    image: '/equipment/yuhoo-basic.webp', alt: 'Yuhoo Basic MSI Codex R2 tower PC',
  ...
  {
    number: '02', name: 'Yuhoo Business', label: 'High-performance operations',
    image: '/equipment/yuhoo-business.webp', alt: 'Yuhoo Business HP OMEN MAX 45L tower PC',
  ...
  {
    number: '03', name: 'Yuhoo Enterprise', label: 'Professional AI workstation',
    image: '/equipment/yuhoo-enterprise.webp', alt: 'Yuhoo Enterprise CLX professional workstation',
  ...
  return <main>
    ...
    <section className="systems-section section-shell">
      <div className="section-head">
        <span className="section-index">YUHOO SYSTEMS</span>

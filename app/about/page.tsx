...
export const metadata: Metadata = pageMetadata('About Yuhoo AI & ERP Systems', 'Yuhoo serves operational small and midsize businesses with Private AI, Odoo ERP, AI ERP integration, automation, and practical implementation support.', '/about');
  ...
  return <main className="about-page">
    <section className="about-hero section-shell">
      <div className="about-hero-copy">
        <span className="eyebrow">ABOUT YUHOO</span>
        <h1>Technology should fit the business. Not the other way around.</h1>
        <p>Yuhoo AI &amp; ERP Systems helps established small and medium-sized businesses modernize with Private AI, Odoo ERP, AI ERP integration, and business automation—without losing the knowledge, discipline, and relationships that made them successful.</p>
    ...
    <section className="authority-body section-shell">
      <section><span>05</span><div><h2>What Yuhoo does not promise</h2><p>We do not represent AI as error-free, ERP as a shortcut around process decisions, or automation as a substitute for accountable people. We do not promise savings, timing, security, or business outcomes before the current environment and scope are understood.</p></div></section>
      <section><span>06</span><div><h2>Who we serve</h2><p>Yuhoo works with operational small and medium-sized businesses across the United States, with particular attention to wholesale distribution, HVAC and field service, construction, manufacturing, retail, and professional services.</p><p><a href="/how-yuhoo-works">Read the implementation process</a>{' · '}<a href="/trust">Review trust and data practices</a>{' · '}<a href="/case-studies">Understand our evidence standard</a></p></div></section>
    </section>

...
export const metadata=authorityMetadata('Terms of Use','Terms for using Yuhoo public information, assessments, calculators, member tools, and consultation forms.','/terms');
export default function Page(){return <AuthorityPage eyebrow="TERMS OF USE" title="Use planning tools as guidance—not a guarantee." intro="These terms govern use of the Yuhoo website. A signed agreement, not this website, defines any paid implementation or advisory engagement." sections={[
...
{title:'Changes and contact',body:'The website and these terms may change as services evolve. Questions may be sent to info@yuhoo.ai or 281-258-8000.'}
]} />}

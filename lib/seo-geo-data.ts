...
export const strategicKeywords = [
  ['Yuhoo','Branded','/','High'],['Yuhoo AI','Branded','/','High'],['Yuhoo AI ERP','Branded','/','High'],['Yuhoo ERP','Branded','/','High'],['Yuhoo Private AI','Branded','/ai-solutions','High'],
...
export const importantRoutes = ['/','/ai-solutions','/erp-solutions','/website-design','/ai-erp','/equipment','/industries','/industries/restaurants','/pricing','/about','/contact','/free-account','/assessment','/resources','/resources/private-ai','/resources/odoo-erp','/resources/ai-erp','/resources/business-automation','/resources/comparisons','/resources/guides','/resources/industries/wholesale-distribution','/resources/industries/hvac-field-service','/case-studies','/how-yuhoo-works','/trust'];
...
export async function ensureSeoGeoSeed() {
  ...
  const indexingStatements=importantRoutes.map(route=>db.prepare("INSERT OR IGNORE INTO seo_indexing_status (url,indexed_status,expected_canonical,in_sitemap,updated_at) VALUES (?,'Unknown',?,1,?)").bind(route,`https://yuhoo.ai${route==='/'?'':route}`,now));
  const taskRows=[
